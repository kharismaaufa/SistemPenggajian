...
<div class="card mb-3">
  ...
  <div class="card-body">
      <form class="form-inline">
        ...
        <?php if(count($gaji) > 0) { ?>
            <a href="<?php echo base_url('admin/dataPenggajian/cetakGaji?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-4"><i class="fas fa-print"> Cetak Daftar Gaji</i></a>
        <?php }else{ ?>
            <button type="button" class="btn btn-success mb-2 ml-4" data-toggle="modal" data-target="#exampleModal">
...
<div class="alert alert-info">
    Menampilkan Data Gaji Karyawan : <span class="font-weight-bold"><?php echo $bulan ?></span> Tahun : <span class="font-weight-bold"><?php echo $tahun ?></span>
</div>
