...
<div class="card mb-3">
  ...
  <div class="card-body">
      <form class="form-inline">
        ...
        <a href="<?php echo base_url('admin/dataAbsensi/inputAbsensi') ?>" class="btn btn-success mb-2 ml-4"><i class="fas fa-plus"> Input Kehadiran</i></a>
...
<?php }else{ ?>
    <span class="badge badge-danger"><i class="fas fa-info-circle"></i>Data kosong, Silahkan Input data kehadiran pada bulan dan tahun yang Anda pilih!</span>
<?php } ?>
